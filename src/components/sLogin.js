...
export default class Login extends React.Component {
      ...
      login = e=> {
        ...
        if(email.length > 0 && password.length > 0){
            ...
            axios
            .post('http://localhost:8383/api/login/s-login',data)
            .then(response => {
      ...
      return (
          <div className="container py-5" style={{width:'100vw'}}>
                ...
                <div className="card-header bg-info text-white">
                        <h3 className="text-center"><strong>Student Login</strong></h3>
                </div>
                <div className="card-body ">
                    ...
                    <Form >
                        ...
                        <Col sm={{ size: 10, offset: 2 }}>
                            <Button type="submit" onClick={this.login}>Submit</Button> don't have an account?<a href = "/student/register">Register</a>
                        </Col>
                        </FormGroup>
                    </Form>
                </div>
